...
submit.addEventListener("click", () => {
  ...
  if (validateEmail.match(dot)) {
    alert("Ошибка регистрации, возможно ваша почта katerina.pochkina95@bigmir.net?")
  }
  if(firstName.value && lastName.value && email.value && password.value) {
    if(validatePassword.match(regWithUpperCase) || !sendYoubike.checked || (password.value != confirmPassword.value)) {
